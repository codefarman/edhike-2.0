...
//     roles: "Manager, Consultant, Strategist, Entrepreneur",
//     description:
//       "Accelerate your leadership journey with an accredited online MBA.",
//     icon: School,
//     color: PURPLE,
//     slug: "mba",
//   },
...
//     roles: "Operations Manager, Team Lead, Founder",
//     description:
//       "Gain practical management skills in strategy, operations, HR, or entrepreneurship.",
//     icon: Groups,
//     color: RED,
...
//     roles: "Business, Tech, Healthcare, Data Science",
//     description:
//       "Elevate your career with a specialized online Master’s program offering advanced knowledge and practical skills.",
//     icon: Public,
//     color: PURPLE,
//     slug: "global-mba",
//   },
...
//                  > 
//                  <ChevronLeft sx={{ fontSize: 28, color: PURPLE }} /> </IconButton>
...
//                 }}
//               >
//                 <ChevronRight sx={{ fontSize: { xs: 20, sm: 28 }, color: PURPLE }} />
//               </IconButton>
...
export default function Programs() {
  ...
  <SwiperSlide key={prog.slug} style={{ width: 250 }}>
    <StaggerItem>
      <ScaleIn delay={i * 0.05}>
        <ProgramCard prog={prog} />
      </ScaleIn>
...
function ProgramCard({ prog }) {
  ...
  return (
    ...
    >
      ...
      >
        <Icon sx={{ fontSize: 40, color: prog.color }} />
      </Box>
